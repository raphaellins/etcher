...
exports.toggleDrive = (driveDevice) => {
  if (exports.isSelectedDrive(driveDevice)) {
    exports.unselectDrive(driveDevice)
  } else {
    exports.selectDrive(driveDevice)
  }
}
...
/**
 * @summary Unselect all other drives and keep the current drive's status
 * @function
 * @public
 * @deprecated
 *
 ...
 *
 * @example
 * selectionState.unselectOtherDrives('/dev/disk2')
 */
exports.unselectOtherDrives = (driveDevice) => {
  if (exports.isSelectedDrive(driveDevice)) {
    exports.unselectAllDrives()
    exports.selectDrive(driveDevice)
  } else {
    exports.unselectAllDrives()
  }
 ...
 *
 * @example
 * selectionState.unselectDrive('/dev/sdc');
 *
 * @example
 * selectionState.unselectDrive('\\\\.\\PHYSICALDRIVE3');
 */
exports.unselectDrive = (driveDevice) => {
  store.dispatch({
 ...
 *
 * @example
 * selectionState.unselectAllDrives()
 */
exports.unselectAllDrives = () => {
  _.map(exports.getSelectedDevices(), exports.unselectDrive)
}
 ...
 *
 * @example
 * const isSelected = selectionState.isSelectedDrive('/dev/sdb')
 *
 * if (isSelected) {
 *   selectionState.unselectDrive(driveDevice)
 * }
 */
